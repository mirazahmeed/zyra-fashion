    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8">
          <h1 className="text-2xl font-light tracking-wide text-black mb-2 text-center">
            {isLogin ? 'Welcome Back' : 'Create Account'}
          </h1>
          <p className="text-sm font-light text-gray-600 mb-8 text-center">
          ...
          {!showVerificationMessage ? (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full mb-6 flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
